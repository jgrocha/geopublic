...
Ext.define('GeoPublic.Application', {
	...
	controllers : ['TopHeader', 'Users.Profile', 'StartPanel', 'MainMapPanel', 'BemVindoPanel', 'Promotor', 'Plano', 'TipoOcorrencia', 'Participation.Contribution', 'Participation.Discussion', 'Participation.EstadoOcorrencia', 'Participation.Fotografia', 'DiscussaoRegulamento'],
