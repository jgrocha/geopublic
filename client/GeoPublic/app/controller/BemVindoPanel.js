Ext.define('GeoPublic.controller.BemVindoPanel', {
	...
	onLaunch : function() {
		// console.log('...O controlador GeoPublic.controller.BemVindoPanel onLaunch.');
	},
	...
	onBemVindoPanelBeforeRender : function(bemVindoPanel, options) {
		var me = this;
		// console.log('controlador GeoPublic.controller.BemVindoPanel onBemVindoPanelBeforeRender');
	},
	onBemVindoPanelAfterRender : function(bemVindoPanel, options) {
		var me = this;
		// console.log('controlador GeoPublic.controller.BemVindoPanel onBemVindoPanelAfterRender');
